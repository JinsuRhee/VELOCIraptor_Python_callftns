...
from vr.fortran.find_domain_py import find_domain_py
from vr.fortran.get_ptcl_py import get_ptcl_py
from vr.fortran.get_flux_py import get_flux_py
from vr.fortran.jsamr2cell_totnum_py import jsamr2cell_totnum_py
from vr.fortran.jsamr2cell_py import jsamr2cell_py
from vr.fortran.js_gasmap_py import js_gasmap_py
...
class vr_load:
    ...
    def __init__(self, simtype, cname=False, num_thread=1):
        ...
        self.dir_table  = 'vr/table'#pkg_resources.resource_filename('vr', 'table/')
        self.ssp_type   = 'chab'
